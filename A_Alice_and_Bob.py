'''
Alice and Bob have a bag with n marbles, with the integer vi written on the i-th marble. They play the following game: first, each player chooses an integer (let's denote the integer chosen by Alice as a, and the integer chosen by Bob as b
...
(0≤b≤2⋅109) that Bob should choose to maximize the number of points he receives. If there are multiple such numbers, you may output any of them.
'''
